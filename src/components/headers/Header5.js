            ...
            <Row className="align-items-center text-left">
              <Col lg="5" xs="12">
                ...
                <p className="lead pb-4">
                  Hemos creado una red social para la comunidad deportiva donde puedes
                  crear partidos de futbol, equipos y entrenamientos ! 
                </p>
              ...
              <Col className="pl-0" lg="7" xs="12">
                <img
                  alt="..."
                  className="ml-lg-5"
                  src={require("assets/img/ill/icon-header.svg").default}
                  width="100%"
                ></img>
              </Col>
            </Row>
