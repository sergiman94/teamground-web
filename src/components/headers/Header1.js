      ...
      <header className="header-1">
        ...
        <div className="page-header">
          <div
            ...
            style={{
              // backgroundImage:"url(" + require("assets/img/ill/p2.svg").default + ")"
            }}
          ></div>
          <Container>
            <Row>
              <Col
                ...
                md="7"
              >
                <h3 className="display-3">TeamGround</h3>
                <p className="lead mt-0">
                  Hemos creado una red social para ti y toda la comunidad deportiva
                </p>
                <br></br>
